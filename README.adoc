...
IGoR's exhaustive *_documentation can be found http://statbiophys.github.io/IGoR[here]_*!

Download the latest release https://github.com/statbiophys/IGoR/releases[here].
...
Documentation
-------------
A comprehensive documentation of IGoR is available on the internet at: http://statbiophys.github.io/IGoR[http://statbiophys.github.io/IGoR] or in your local installation of IGoR as the `./docs/index.html` file. 
...
https://github.com/statbiophys/IGoR/issues[issue] or email mailto:quentin.marcou@lpt.ens.fr[us].
